...
<template>
  <div class="entity-table">
    ...
    <div class="entity-table-main" v-loading="loading">
      <el-table height="100%" :data="tableData.data" border>
        <el-table-column
          align="center"
          type="selection"
          width="60">
...
<!--                   size="mini">-->
<!--                 </el-input-number>-->
<!--                &lt;!&ndash;<el-button size="mini" @click.stop="scoreSubmit(scope.row, 'reliability')">确定</el-button>&ndash;&gt;-->
...
<!--                   size="mini">-->
<!--                 </el-input-number>-->
<!--                &lt;!&ndash;<el-button size="mini" @click.stop="scoreSubmit(scope.row, 'score')">确定</el-button>&ndash;&gt;-->
          ...
          <template #default="scope">
            <el-space>
              <el-link
                :underline="false"
                type="primary"
                @click="editInstance(scope.row)">关系编辑
              </el-link>
            </el-space>
          </template>
        </el-table-column>
